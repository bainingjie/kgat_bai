...
def run_recbole(
    ...
    print("torchcontribute is installed in quick_start.py")
    ...
    # print("build config",is_swa,is_momentum)

    # config["is_swa"]=config["is_swa"][0]
    # config["is_momentum"]=config["is_momentum"][0]
