...
class Trainer(AbstractTrainer):
    ...
    def __init__(self, config, model):
        ...
        self.is_swa=config["is_swa"]
        self.is_momentum=config["is_momentum"]
        ...
        print("optimizer",self.is_swa,self.is_momentum)
    def _build_optimizer(self, **kwargs):
        ...
        print("pytorch contribu imported in trainer.py")


        # SWA　old
        # from torchcontrib.optim import SWA
        # base_opt = optim.SGD(params, lr=learning_rate, weight_decay=weight_decay)
